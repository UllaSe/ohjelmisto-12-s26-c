...
# while / else rakenne
# suoritua siirtyy else-haaraan kun toistoehto on epätosi
...
# sama nopanheitto uudestaan, nyt sisäkäisellä toistorakenteella
...
while peli_käynnissä:
    print('Anna ohjeita pelaajalle, tee jotain')
    # kun peli on pelattu
